    ...
    <div class="max-w-4xl mx-auto space-y-10 pb-20">
        ...
        <div class="relative group">
            <div class="flex overflow-x-auto pb-6 hide-scrollbar snap-x snap-mandatory gap-6" style="scrollbar-width: none; -ms-overflow-style: none;">
                ...
                <div class="min-w-full md:min-w-[400px] snap-center bg-gradient-to-br from-indigo-600 to-violet-700 p-8 rounded-[2.5rem] shadow-2xl shadow-indigo-500/20 relative overflow-hidden">
                    ...
                    <p class="text-indigo-100 text-[10px] font-bold uppercase tracking-widest mb-2">Total Wealth</p>
                    ...
                    <div class="flex justify-between items-end">
                        ...
                        <span class="px-4 py-2 bg-black/20 rounded-2xl text-white text-xs font-bold backdrop-blur-md">Live Status</span>
                    </div>
                </div>
                ...
                <div class="min-w-full md:min-w-[400px] snap-center bg-slate-900 p-8 rounded-[2.5rem] border border-white/5 relative overflow-hidden">
                    ...
                    <p class="text-slate-500 text-[10px] font-bold uppercase tracking-widest mb-2">Investment Funds</p>
                    <h2 class="text-4xl font-black text-white mb-8">{{ $activeFunds }} <span class="text-lg font-normal text-slate-500 italic">Portfolios</span></h2>
                ...
                <div class="min-w-full md:min-w-[400px] snap-center bg-rose-600 p-8 rounded-[2.5rem] shadow-2xl shadow-rose-500/20 relative overflow-hidden">
                    <p class="text-rose-100 text-[10px] font-bold uppercase tracking-widest mb-2">Outstanding Debts</p>
                    <h2 class="text-4xl font-black text-white mb-8">${{ number_format($totalDebts, 2) }}</h2>
                    <div class="flex items-center space-x-2 text-rose-200 font-bold text-sm">
        ...
        <div class="grid grid-cols-4 gap-4 px-2">
            ...
            <button class="flex flex-col items-center space-y-2 group">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Expense</span>
            </button>
            <button class="flex flex-col items-center space-y-2 group">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Transfer</span>
            </button>
            <button class="flex flex-col items-center space-y-2 group">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Stats</span>
            </button>
        </div>
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between px-4">
                ...
                <button class="text-indigo-400 text-sm font-bold">Show All</button>
            </div>
            ...
            <div class="space-y-3 px-2">
                @forelse($recentTransactions as $transaction)
                    <div class="glass p-5 rounded-[2.5rem] border border-white/5 flex items-center justify-between hover:bg-white/[0.03] transition-all group cursor-pointer shadow-sm">
                        <div class="flex items-center">
                            <!-- Category Icon -->
                            <div class="w-14 h-14 rounded-2xl flex items-center justify-center mr-4 relative">
                                @php
                            ...
                            <div>
                                ...
                                <p class="text-slate-500 text-[11px] font-bold uppercase tracking-widest">{{ $transaction->wallet->name ?? 'Fund' }} • {{ $transaction->transaction_date->format('d M, H:i') }}</p>
                            </div>
                        </div>
                ...
                @empty
                    <div class="text-center py-20 bg-slate-900/30 rounded-[3rem] border-dashed border-2 border-slate-800">
                        <p class="text-slate-500 font-medium">Your financial timeline is empty.</p>
                        <p class="text-slate-600 text-xs">Start adding transactions to see them here.</p>
                    </div>
                @endforelse
            </div>
        </div>
        ...
        <div class="glass p-8 rounded-[3rem] border border-white/5 mx-2">
            <h3 class="text-xl font-bold text-white mb-8">Financial Pulse</h3>
