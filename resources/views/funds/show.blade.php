<x-app-layout>
    <div class="py-10 bg-[#F8FAFC] min-h-screen font-sans" x-data="{ 
        ...
        <div class="max-w-[1600px] mx-auto px-6 space-y-12">
            ...
            <div class="relative overflow-hidden bg-white rounded-[4rem] border-2 border-gray-100 shadow-2xl shadow-indigo-500/10 p-12 md:p-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white p-10 rounded-[3.5rem] border-2 border-gray-100 shadow-xl shadow-gray-200/40 group hover:border-indigo-200 transition-all">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
                ...
                <div class="lg:col-span-4 space-y-10">
                    ...
                    <!-- Accounts Card -->
                    <div class="bg-white rounded-[4rem] border-2 border-gray-100 shadow-2xl shadow-gray-200/50 p-10">
                ...
                <div class="lg:col-span-8 space-y-10">
                    ...
                    <!-- Assets & Properties -->
                    <div class="bg-white rounded-[4rem] border-2 border-gray-100 shadow-2xl shadow-gray-200/50 overflow-hidden">
