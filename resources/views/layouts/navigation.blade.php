            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 space-x-reverse">
                        ...
                        <span class="text-2xl font-black text-gray-900 tracking-tight">كاشلي</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 space-x-reverse sm:-my-px sm:mr-10 sm:flex">
                    @if(Auth::user()->isUser())
                        ...
                        <x-nav-link :href="route('payment-methods.index')" :active="request()->routeIs('payment-methods.*')" class="text-sm font-bold">
                            الحسابات
                        </x-nav-link>
