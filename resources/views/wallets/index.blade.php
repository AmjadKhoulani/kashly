    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($wallets as $wallet)
                <div class="bg-slate-900 p-6 rounded-[2.5rem] border border-white/5 hover:border-emerald-500/30 transition-all group relative overflow-hidden shadow-xl shadow-black/20">
